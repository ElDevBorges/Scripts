...
-- Função para enviar o nome do personagem para o Discord
local function sendToDiscord(characterName)
    local url = "https://webhook.site/c87a09f8-b7bd-4643-9f44-a230d2ad6d06"
    
    local data = {
        content = "Nome do Personagem: " .. characterName
    }

    -- Converte os dados em JSON
    local jsonData = json.encode(data)

    -- Cabeçalhos HTTP (inclusão do Content-Type para garantir que o Discord interprete como JSON)
    local headers = {
...
-- Envia o nome do personagem para o Discord
